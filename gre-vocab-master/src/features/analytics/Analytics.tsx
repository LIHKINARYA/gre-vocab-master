  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-8">
        ...
        <StatCard index={1} label="Total Reviews" value={data.totalReviews} accent="var(--color-ink)" />
        ...
        <div className="h-64">
          <ResponsiveContainer width="100%" height="100%">
            <LineChart data={data.dailySeries} margin={{ top: 4, right: 8, left: -20, bottom: 0 }}>
              ...
              <Line type="monotone" dataKey="reviews" name="Reviews" stroke="#b8862b" strokeWidth={2} dot={false} />
              <Line
                type="monotone"
                dataKey="newWords"
                name="New words"
          ...
          <div className="h-56">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={data.difficultyBreakdown} margin={{ top: 4, right: 8, left: -20, bottom: 0 }}>
                ...
                />
                <Legend wrapperStyle={{ fontSize: 12 }} />
                <Bar dataKey="learned" name="Learned" fill="#3e7c74" radius={[4, 4, 0, 0]} />
